...
[「フィジカルAIとは何か」問う機会に――「エッジAIイニシアチブ 2026」開催！](https://eetimes.itmedia.co.jp/ee/articles/2605/22/news053.html)

## 感想/質問/その他(振り返り)

卒業制作のアイデアを薄々考えていたものを菊池さんに言ってみたが、可能ではありそうだし、現実的に見てもプロトタイプレベルのものなら制作自体はそこまでかからなさそうである。
IoTプロジェクトを一通り確認したら本格的に考えていきたい。
